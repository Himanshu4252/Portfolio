...
const ThirdPage = () => {
  return (<div className={style.thirdWrapper}>
    <div className={style.upperHeadline}>What I can do</div>
    <div className={style.expertiseSection}>
        <div className={style.expertise}>DSA
        <div className={style.svgBox}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className={style.svgIcon}>
        ...
        <div className={style.expertise}>Web development
        <div className={style.svgBox}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className={style.svgIcon}>
        ...
        <div className={style.expertise}>UI/UX designing
        <div className={style.svgBox}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={style.svgIcon}>
